  ...
  return (
    <section className="grid">
      <div className="grid-container">
        ...
        <div className="grid-content">{grid && generateChannels()}</div>
      </div>
    </section>
  );
};
...
const ChannelCover = ({ index, id, title, url, isLoading }) => {
  ...
  return (
    <div className={"cover" + visible + size} onClick={() => redirectandPlay()}>
      ...
      {require(`../../assets/images/covers/${id}.jpg`) ? (
        <img alt={id} src={require(`../../assets/images/covers/${id}.jpg`)} />
      ) : (
        <img
          alt={id}
          src={require(`../../assets/images/covers/undefined.jpg`)}
        />
      )}
